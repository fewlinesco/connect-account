...
export const ConnectProfileApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Delete a user\'s address based on address ID
        ...
        /**
         * Retrieve a user\'s address based on address ID
         * @param {string} id the Address ID identifier of the requested Address
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        ...
        /**
         * Update a user\'s address based on the provided address ID
         * @param {string} id the Address ID identifier of the requested Address
         * @param {AddressData} addressData 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateAddress: async (id: string, addressData: AddressData, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
            assertParamExists('updateAddress', 'id', id)
            // verify required parameter 'addressData' is not null or undefined
            assertParamExists('updateAddress', 'addressData', addressData)
            const localVarPath = `/users/me/addresses/{id}`
                .replace(`{${"id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const ConnectProfileApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteAddress(id: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async updateAddress(id: string, addressData: AddressData, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AddressResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.updateAddress(id, addressData, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ConnectProfileApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        updateAddress(id: string, addressData: AddressData, options?: any): AxiosPromise<AddressResponse> {
            return localVarFp.updateAddress(id, addressData, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ConnectProfileApi extends BaseAPI {
     ...
     * @memberof ConnectProfileApi
     */
    public deleteAddress(id: string, options?: any) {
        return ConnectProfileApiFp(this.configuration).deleteAddress(id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ConnectProfileApi
     */
    public getAddress(id: string, options?: any) {
        return ConnectProfileApiFp(this.configuration).getAddress(id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ConnectProfileApi
     */
    public updateAddress(id: string, addressData: AddressData, options?: any) {
        return ConnectProfileApiFp(this.configuration).updateAddress(id, addressData, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const ConnectProfileAdminApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * Delete a user\'s address based on the provided sub and address id
         * @param {string} sub the sub identifier of the requested User
         * @param {string} id the address unique identifier of the address to delete
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteOneUserAddress: async (sub: string, id: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'sub' is not null or undefined
            assertParamExists('deleteOneUserAddress', 'sub', sub)
            // verify required parameter 'id' is not null or undefined
            assertParamExists('deleteOneUserAddress', 'id', id)
            const localVarPath = `/users/{sub}/addresses/{id}`
        ...
        /**
         * Delete a user profile based on the provided sub
         * @param {string} sub the sub identifier of the requested User to delete
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        deleteProfile: async (sub: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'sub' is not null or undefined
            assertParamExists('deleteProfile', 'sub', sub)
            const localVarPath = `/users/profiles/{sub}`
                .replace(`{${"sub"}}`, encodeURIComponent(String(sub)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const ConnectProfileAdminApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteOneUserAddress(sub: string, id: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteOneUserAddress(sub, id, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Delete a user profile based on the provided sub
         ...
         * @throws {RequiredError}
         */
        async deleteProfile(sub: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteProfile(sub, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ConnectProfileAdminApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteOneUserAddress(sub: string, id: string, options?: any): AxiosPromise<void> {
            return localVarFp.deleteOneUserAddress(sub, id, options).then((request) => request(axios, basePath));
        },
        /**
         * Delete a user profile based on the provided sub
         * @param {string} sub the sub identifier of the requested User to delete
         ...
         * @throws {RequiredError}
         */
        deleteProfile(sub: string, options?: any): AxiosPromise<void> {
            return localVarFp.deleteProfile(sub, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ConnectProfileAdminApi extends BaseAPI {
     ...
     */
    public deleteOneUserAddress(sub: string, id: string, options?: any) {
        return ConnectProfileAdminApiFp(this.configuration).deleteOneUserAddress(sub, id, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof ConnectProfileAdminApi
     */
    public deleteProfile(sub: string, options?: any) {
        return ConnectProfileAdminApiFp(this.configuration).deleteProfile(sub, options).then((request) => request(this.axios, this.basePath));
    }
}
