...
- *lighthouserc.js*: Instructions for Lighthouse reviews.
...
- *lint-and-tests*: runs code linting and integration/unit tests.
- *e2e-tests*: runs e2e tests suite on a deployed Connect Account version.
- *lighthouse*: runs Lighthouse reports on a deployed Connect Account version.
- *promote-to-production*: use to automate production deployment from staging when all tests suite is successful.
