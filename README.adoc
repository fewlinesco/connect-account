...
Thanks to the https://docs.sentry.io/platforms/javascript/guides/nextjs/[Sentry Next.js SDK], the implementation is now way cleaner. We have added a wrapper around the `withSentry` middleware to be able to use is it with SSR.
