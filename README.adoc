...
Install and configure `hivemind`
...
Fill your `Procfile` file with the following:
...
From now on, run `hivemind` to start your server, and acces your application on URL: `https://connect-account.local:29704`