...
To prepare the `users` table you'll need to run:
[source, shell]
----
yarn db:create-users-table
----

If you want to reset the `users` table, run:
[source, shell]
----
yarn db:reset-users-table
----

If you want to delete the `users` table, run:
[source, shell]
----
yarn db:delete-users-table
----
